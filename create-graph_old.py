...
#splits the json_data and returns a touple (ways, nodes)
...
#TODO: Check, if this funktion is returning the correct value.
...
#deletes all nodes which are from paris further away than 900km (important for France) 
